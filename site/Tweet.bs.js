...
function renderTweet(tweet) {
  var getImages = function (d) {
    ...
    var getImage = function (image) {
      ...
      var img = "<img src=\"" + small + ("\" width=\"" + width + "\" height=\"" + height + "\" />");
  ...
  var getText = function (retweetStatus, tweetStatus) {
    var replaceUrlWithLink = function (text, url) {
      return text.replace(url.url, "<a href=\"" + url.url + "\" target=\"_blank\">" + url.display_url + "</a>");
    };
  ...
  var a = "<a href=\"https://twitter.com/" + user + "/status/" + tweet.id_str + "\"\"\" target=\"_blank\">" + time + "</a>";
